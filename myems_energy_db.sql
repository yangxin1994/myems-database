...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_db`.`tbl_tenant_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_db`.`tbl_tenant_hourly` ;

CREATE TABLE IF NOT EXISTS `myems_energy_db`.`tbl_tenant_hourly` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  ...
  `actual_value` DECIMAL(18, 3) NOT NULL,
  PRIMARY KEY (`id`));
CREATE INDEX `tbl_tenant_hourly_index_1` ON  `myems_energy_db`.`tbl_tenant_hourly`   (`tenant_id`, `energy_category_id`, `start_datetime_utc`);

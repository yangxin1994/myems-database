...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_db`.`tbl_combined_equipment_output_item_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_db`.`tbl_combined_equipment_output_item_hourly` ;

CREATE TABLE IF NOT EXISTS `myems_energy_db`.`tbl_combined_equipment_output_item_hourly` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `combined_equipment_id` BIGINT NOT NULL,
  `energy_item_id` BIGINT NOT NULL,
  `start_datetime_utc` DATETIME NOT NULL,
  `actual_value` DECIMAL(18, 3) NOT NULL,
  PRIMARY KEY (`id`));
CREATE INDEX `tbl_combined_equipment_output_item_hourly_index_1` ON  `myems_energy_db`.`tbl_combined_equipment_output_item_hourly`   (`combined_equipment_id`, `energy_item_id`, `start_datetime_utc`);
...
CREATE TABLE IF NOT EXISTS `myems_energy_db`.`tbl_equipment_output_item_hourly` (
  ...
  `actual_value` DECIMAL(18, 3) NOT NULL,
  PRIMARY KEY (`id`));
CREATE INDEX `tbl_equipment_output_item_hourly_index_1` ON  `myems_energy_db`.`tbl_equipment_output_item_hourly`   (`equipment_id`, `energy_item_id`, `start_datetime_utc`);
...
CREATE TABLE IF NOT EXISTS `myems_energy_db`.`tbl_space_output_item_hourly` (
  ...
  `actual_value` DECIMAL(18, 3) NOT NULL,
  PRIMARY KEY (`id`));
CREATE INDEX `tbl_space_output_item_hourly_index_1` ON  `myems_energy_db`.`tbl_space_output_item_hourly`   (`space_id`, `energy_item_id`, `start_datetime_utc`);

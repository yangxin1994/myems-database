...
CREATE TABLE IF NOT EXISTS `myems_system_db`.`tbl_meters` (
  ...
  `hourly_low_limit` DECIMAL(18, 3)  NOT NULL COMMENT 'Inclusive. Default is 0.000. If the meter has accuracy problems, set the value to a small positive value, such as 0.100',
